...
vm_parameters = [("vm1", "br-int", "1", "5901"),  # Coloca los parámetros de las VMs aquí
                 ("vm2", "br-int", "2", "5902"),
                 ("vm3", "br-int", "3", "5903")]
...
execute_on_headnode(f"./init_headnode.sh {headnode_ovs_name} {headnode_interfaces}")
for vlan_param in vlan_parameters:
    execute_on_headnode(f"./internal_net_headnode.sh {' '.join(vlan_param)}")
